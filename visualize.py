...
def visualize_nuscenes_highres(bin_path, output_path):
    ...
    # 5. Camera View
    # NuScenes is 360, so a higher elevation looks good to see the whole intersection
    ax.view_init(elev=40, azim=-135)

    # 6. Force Aspect Ratio
    # Simple bounding box logic to keep geometry correct
    max_range = 30 # Since we filtered to 40m
    
    ax.set_xlim(-max_range, max_range)
    ax.set_ylim(-max_range, max_range)
    ax.set_zlim(-5, 5) # Z range is smaller
...
if __name__ == "__main__":
    ...
    bin_file_kitti = "/DATA/kitti_mmdet3d/training/velodyne/000220.bin"
    bin_file_nuscenes = "/DATA/nuScenes/samples/LIDAR_TOP/n008-2018-05-21-11-06-59-0400__LIDAR_TOP__1526915246547642.pcd.bin"
    visualize_kitti(bin_file_kitti, "kitti_scene.png")

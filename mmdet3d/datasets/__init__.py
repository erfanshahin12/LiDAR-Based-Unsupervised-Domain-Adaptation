...
from .mt_combined_dataset import (MTCombinedDataset, mean_teacher_collate_fn)
...
__all__ = [
    ...
    'MTCombinedDataset', 'mean_teacher_collate_fn',                     # mean-teacher dataset class and custom collate function
]
